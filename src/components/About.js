...
const About = () => {
    return (
        <div className='my-10 relative' id='about'>
            ...
            <div className='absolute top-32 pr-12 md:px-12 lg:px-12'>
                ...
                <p className='hidden w-[700px] md:hidden lg:block text-md leading-loose pt-4 pr-24'>I am a highly professional goal oriented web developer. I aim to make a great career in this field and enrich my knowledge constantly. I want to work in a company/organization where I can contribute actively and get the chance learn from my seniors and colleagues.
                    <br />
                    I am from Chittagong, Bangladesh. I have recently finished my bachelors in Public Administration from University of Chittagong. I like technology, reading books, travelling in my free time.
                </p>
