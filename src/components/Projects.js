            ...
            <div className="grid grid-cols-1 gap-2 justify-items-center pt-5 md:grid-cols-2 lg:grid-cols-3">
                <div className="card w-96 bg-base-100 shadow-lg shadow-teal-300 pt-5">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions">
                            ...
                            <button className="btn btn-primary mx-2"><a href="https://phone-down-shop.web.app/" target='_blank' rel='noreferrer noopener'>Live</a></button>
                ...
                <div className="card w-96 bg-base-100 shadow-lg shadow-teal-300 pt-5">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions">
                            <button className="btn btn-primary">View Details</button>
                            <button className="btn btn-primary mx-2"><a href="https://dental-whiz-website.web.app/" target='_blank' rel='noreferrer noopener'>Live</a></button>
                ...
                <div className="card w-96 bg-base-100 shadow-lg shadow-teal-300 pt-5">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions">
                            <button className="btn btn-primary">View Details</button>
                            <button className="btn btn-primary mx-2"><a href="https://learning-website-react-72397.web.app/" target='_blank' rel='noreferrer noopener'>Live</a></button>
